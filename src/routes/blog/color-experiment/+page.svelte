...
<svelte:head>
	...
	<meta property="og:url" content="https://svelteboard.com/blog/color-experiment" />
...
<div class="max-w-xl m-auto">
	...
	<div class="flex space-x-4">
		<div class="">
			<span class="block text-sm font-medium leading-6 text-slate-900">Mix Blend</span>
			<select
				bind:value={mixBlend}
				name="Mix Blend"
				class="max-w-lg block focus:ring-blue-500 focus:border-blue-500 w-full shadow-sm sm:max-w-xs sm:text-sm border-slate-300 rounded-md mt-2"
			>
...
<div class="min-h-screen min-w-full">
	<div
		class="z-10 relative mt-6 -mb-6 text-center text-xs leading pt-3 text-slate-900 dark:text-slate-400"
	>
...
932 5 2049 6 1949 1 2032 0 2070 -18z"
				...
				<div
					style="background-color:{color}; opacity:{opacity /
						100}; mix-blend-mode:{mixBlend}; margin-top:{phone ? '41px' : '52px'}"
					class="absolute inset-0 z-10 {toggleMask ? '' : 'hidden'}"
				/>
				<iframe
					src="https://{active_url}"
					bind:this={iframe}
...
<div class="max-w-3xl m-auto prose prose-slate clear-both pt-8 pb-32 prose-a:text-blue-600">
	...
	<ul>
		<li>
			<a href="https://twitter.com/steveschoger/status/1502318105124646924" target="_blank"
				>Steve's tweet</a
			>
		</li>
		<li>
			<a href="https://medium.com/@JustinMezzell/how-i-work-with-color-8439c98ae5ed" target="_blank"
				>How I Work with Color by Justin Mezzell</a
			>
		</li>
		<li>
		...
		<li>
			<a href="https://play.tailwindcss.com/kY4LYXwsNZ" target="_blank"> iPhone Summary Demo </a>
		</li>
		<li>
